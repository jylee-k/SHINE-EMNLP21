...
if __name__ == '__main__':
    ...
    parser.add_argument("--concat_phrase_emb", type=bool, default=True,
                            help="concat phrase embedding with pretrained model")
    ...
    params.save_name = params.save_path + './result_torch_{}_fine_no-phrase-tag.json'.format(params.dataset)
